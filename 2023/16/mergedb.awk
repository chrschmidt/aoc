...
function trace(x,y,dir) {
    ...
    energized[x,y][dir]
    switch(world[y][x]) {
    case ".": return step(x,y,dir)
    case "/": 
        switch(dir) {
        case 0: return step(x,y,1)
        case 1: return step(x,y,0)
        case 2: return step(x,y,3)
        case 3: return step(x,y,2)
    }
    case "\\":
        switch(dir) {
        case 0: return step(x,y,3)
        case 1: return step(x,y,2)
        case 2: return step(x,y,1)
        case 3: return step(x,y,0)
        }
    case "-": switch(dir) {
        case 0:
        case 2: step(x,y,3); return step(x,y,1)
        default: return step(x,y,dir)
        }
    case "|": switch(dir) {
        case 1:
        case 3: step(x,y,0); return step(x,y,2)
        default: return step(x,y,dir)
        }
    }
}
